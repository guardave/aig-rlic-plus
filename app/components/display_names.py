...
INDICATOR_NAMES: dict[str, str] = {
    ...
    "rsxfs_spy": "Advance Retail Sales",
    "sloos_ci_small": "SLOOS C&I Tightening (Small Firms)",
    "sloos_ci_small_spy": "SLOOS C&I Tightening (Small Firms)",
    "mfg_new_orders": "Manufacturers' New Orders",
    "mfg_new_orders_spy": "Manufacturers' New Orders",
    "import_price": "Import Price Index",
    "import_price_spy": "Import Price Index",
    "cement": "Portland Cement Shipments",
    "cement_spy": "Portland Cement Shipments",
    "ism_mfg": "ISM Manufacturing PMI",
    "ism_mfg_spy": "ISM Manufacturing PMI",
    "umcsent_spy": "U. Michigan Expected Business Conditions",
    "retail_inv_sales": "Retail Inventories-to-Sales Ratio",
    "retail_inv_sales_spy": "Retail Inventories-to-Sales Ratio",
    "cc_delinquency": "Credit Card Delinquency Rate",
    "cc_delinquency_spy": "Credit Card Delinquency Rate",
    "permit_yoy": "Building Permits YoY",
    "permit_yoy_spy": "Building Permits YoY",
    "unrate": "Unemployment Rate",
    "unrate_spy": "Unemployment Rate",
...
SHORT_INDICATOR_LABELS: dict[str, str] = {
    ...
    "housing_starts_spy": "Housing Starts",
    "rsxfs_spy": "Retail Sales",
    "sloos_ci_small_spy": "SLOOS Tightening",
    "mfg_new_orders_spy": "New Orders",
    "import_price_spy": "Import Prices",
    "cement_spy": "Cement",
    "ism_mfg_spy": "ISM Mfg PMI",
    "umcsent_spy": "UoM Exp. Conditions",
    "retail_inv_sales_spy": "Inv/Sales",
    "cc_delinquency_spy": "CC Delinquency",
    "permit_yoy_spy": "Permits YoY",
    "unrate_spy": "Unemployment",
    "cass_freight_spy": "Cass Freight",
    "eci_total_comp_spy": "ECI",
