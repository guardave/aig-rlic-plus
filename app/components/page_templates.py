...
def render_evidence_page(pair_id: str, method_blocks: dict) -> None:
    ...
    _cp_conditional = [
        ("rolling_sharpe", "Rolling Sharpe",   "How to read it: 24-month rolling Sharpe ratio. Persistent positive values confirm the strategy survives across market regimes, not just in a lucky window."),
