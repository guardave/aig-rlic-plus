"""Pair 10 — UMCSENT × XLV Evidence (thin wrapper, Rule APP-PT1).
...
from pair_configs.umcsent_xlv_config import EVIDENCE_METHOD_BLOCKS

render_evidence_page("umcsent_xlv", EVIDENCE_METHOD_BLOCKS)
