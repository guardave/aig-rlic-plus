"""Pair 10 — UMCSENT × XLV Methodology (thin wrapper, Rule APP-PT1).
...
from pair_configs.umcsent_xlv_config import METHODOLOGY_CONFIG

render_methodology_page("umcsent_xlv", METHODOLOGY_CONFIG)
