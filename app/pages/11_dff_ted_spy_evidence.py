"""Pair 11 — DFF-TED × SPY Evidence (thin wrapper, Rule APP-PT1).
...
content lives in ``app/pair_configs/dff_ted_spy_config.py``. See APP-PT1
...
from pair_configs.dff_ted_spy_config import EVIDENCE_METHOD_BLOCKS

render_evidence_page("dff_ted_spy", EVIDENCE_METHOD_BLOCKS)
