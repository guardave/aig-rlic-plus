"""Pair 11 — DFF-TED × SPY Methodology (thin wrapper, Rule APP-PT1).
...
from pair_configs.dff_ted_spy_config import METHODOLOGY_CONFIG

render_methodology_page("dff_ted_spy", METHODOLOGY_CONFIG)
