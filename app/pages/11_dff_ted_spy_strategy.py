"""Pair 11 — DFF-TED × SPY Strategy (thin wrapper, Rule APP-PT1).
...
from pair_configs.dff_ted_spy_config import STRATEGY_CONFIG

render_strategy_page("dff_ted_spy", STRATEGY_CONFIG)
