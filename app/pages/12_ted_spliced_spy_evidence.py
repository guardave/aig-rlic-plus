"""Pair 12 — Spliced TED × SPY Evidence (thin wrapper, Rule APP-PT1).
...
content lives in ``app/pair_configs/ted_spliced_spy_config.py``. See APP-PT1
...
from pair_configs.ted_spliced_spy_config import EVIDENCE_METHOD_BLOCKS

render_evidence_page("ted_spliced_spy", EVIDENCE_METHOD_BLOCKS)
