"""Pair 12 — Spliced TED × SPY Methodology (thin wrapper, Rule APP-PT1).
...
from pair_configs.ted_spliced_spy_config import METHODOLOGY_CONFIG

render_methodology_page("ted_spliced_spy", METHODOLOGY_CONFIG)
