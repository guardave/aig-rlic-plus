"""Pair 12 — Spliced TED × SPY Story (thin wrapper, Rule APP-PT1).
...
from pair_configs.ted_spliced_spy_config import STORY_CONFIG

render_story_page("ted_spliced_spy", STORY_CONFIG)
