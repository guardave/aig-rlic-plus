"""Pair 14 — INDPRO × XLP Evidence (thin wrapper, Rule APP-PT1).
...
content lives in ``app/pair_configs/indpro_xlp_config.py``. See APP-PT1
...
from pair_configs.indpro_xlp_config import EVIDENCE_METHOD_BLOCKS

render_evidence_page("indpro_xlp", EVIDENCE_METHOD_BLOCKS)
