"""Pair 14 — INDPRO × XLP Methodology (thin wrapper, Rule APP-PT1).
...
from pair_configs.indpro_xlp_config import METHODOLOGY_CONFIG

render_methodology_page("indpro_xlp", METHODOLOGY_CONFIG)
