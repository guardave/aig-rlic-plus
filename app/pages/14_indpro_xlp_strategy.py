"""Pair 14 — INDPRO × XLP Strategy (thin wrapper, Rule APP-PT1).
...
from pair_configs.indpro_xlp_config import STRATEGY_CONFIG

render_strategy_page("indpro_xlp", STRATEGY_CONFIG)
