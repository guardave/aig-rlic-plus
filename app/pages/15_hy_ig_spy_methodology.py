"""Pair 15 — HY-IG × SPY Methodology (thin wrapper, Rule APP-PT1).
...
from pair_configs.hy_ig_spy_config import METHODOLOGY_CONFIG

render_methodology_page("hy_ig_spy", METHODOLOGY_CONFIG)
