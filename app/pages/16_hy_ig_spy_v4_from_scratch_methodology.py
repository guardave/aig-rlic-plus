"""Pair 16 — HY-IG × SPY v4 (from scratch) Methodology (thin wrapper, Rule APP-PT1).
...
from pair_configs.hy_ig_spy_v4_from_scratch_config import METHODOLOGY_CONFIG

render_methodology_page("hy_ig_spy_v4_from_scratch", METHODOLOGY_CONFIG)
