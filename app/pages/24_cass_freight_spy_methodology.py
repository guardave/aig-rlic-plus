"""Pair 24 — Cass Freight Index (Shipments) × SPY Methodology (thin wrapper, Rule APP-PT1).
...
from pair_configs.cass_freight_spy_config import METHODOLOGY_CONFIG

render_methodology_page("cass_freight_spy", METHODOLOGY_CONFIG)
