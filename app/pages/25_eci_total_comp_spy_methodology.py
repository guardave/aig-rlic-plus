"""Pair 25 — Employment Cost Index (Total Compensation) × SPY Methodology (thin wrapper, Rule APP-PT1).
...
from pair_configs.eci_total_comp_spy_config import METHODOLOGY_CONFIG

render_methodology_page("eci_total_comp_spy", METHODOLOGY_CONFIG)
