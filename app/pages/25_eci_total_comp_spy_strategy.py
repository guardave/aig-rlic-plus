"""Pair 25 — Employment Cost Index (Total Compensation) × SPY Strategy (thin wrapper, Rule APP-PT1).
...
from pair_configs.eci_total_comp_spy_config import STRATEGY_CONFIG

render_strategy_page("eci_total_comp_spy", STRATEGY_CONFIG)
