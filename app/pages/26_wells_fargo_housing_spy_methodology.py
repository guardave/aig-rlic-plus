"""Pair 26 — NAHB/Wells Fargo Housing Market Index (HMI) × SPY Methodology (thin wrapper, Rule APP-PT1).
...
from pair_configs.wells_fargo_housing_spy_config import METHODOLOGY_CONFIG

render_methodology_page("wells_fargo_housing_spy", METHODOLOGY_CONFIG)
