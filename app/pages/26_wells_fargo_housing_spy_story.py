"""Pair 26 — NAHB/Wells Fargo Housing Market Index (HMI) × SPY Story (thin wrapper, Rule APP-PT1).
...
from pair_configs.wells_fargo_housing_spy_config import STORY_CONFIG

render_story_page("wells_fargo_housing_spy", STORY_CONFIG)
