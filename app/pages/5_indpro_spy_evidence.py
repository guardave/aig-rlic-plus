"""Pair 5 — INDPRO × SPY Evidence (thin wrapper, Rule APP-PT1).
...
content lives in ``app/pair_configs/indpro_spy_config.py``. See APP-PT1
...
from pair_configs.indpro_spy_config import EVIDENCE_METHOD_BLOCKS

render_evidence_page("indpro_spy", EVIDENCE_METHOD_BLOCKS)
