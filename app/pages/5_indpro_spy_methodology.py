"""Pair 5 — INDPRO × SPY Methodology (thin wrapper, Rule APP-PT1).
...
from pair_configs.indpro_spy_config import METHODOLOGY_CONFIG

render_methodology_page("indpro_spy", METHODOLOGY_CONFIG)
