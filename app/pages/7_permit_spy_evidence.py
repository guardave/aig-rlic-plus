"""Pair 7 — PERMIT × SPY Evidence (thin wrapper, Rule APP-PT1).
...
from pair_configs.permit_spy_config import EVIDENCE_METHOD_BLOCKS

render_evidence_page("permit_spy", EVIDENCE_METHOD_BLOCKS)
