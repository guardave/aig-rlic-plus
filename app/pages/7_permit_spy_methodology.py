"""Pair 7 — PERMIT × SPY Methodology (thin wrapper, Rule APP-PT1).
...
from pair_configs.permit_spy_config import METHODOLOGY_CONFIG

render_methodology_page("permit_spy", METHODOLOGY_CONFIG)
