"""Pair 8 — VIX/VIX3M × SPY Story (thin wrapper, Rule APP-PT1).
...
from pair_configs.vix_vix3m_spy_config import STORY_CONFIG

render_story_page("vix_vix3m_spy", STORY_CONFIG)
