"""Pair 8 — VIX/VIX3M × SPY Strategy (thin wrapper, Rule APP-PT1).
...
from pair_configs.vix_vix3m_spy_config import STRATEGY_CONFIG

render_strategy_page("vix_vix3m_spy", STRATEGY_CONFIG)
