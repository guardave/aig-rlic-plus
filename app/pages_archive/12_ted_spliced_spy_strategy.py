"""Pair 12 — Spliced TED × SPY Strategy (thin wrapper, Rule APP-PT1).
...
from pair_configs.ted_spliced_spy_config import STRATEGY_CONFIG

render_strategy_page("ted_spliced_spy", STRATEGY_CONFIG)
