"""Pair 6 — SOFR-TED × SPY Evidence (thin wrapper, Rule APP-PT1).
...
from pair_configs.sofr_ted_spy_config import EVIDENCE_METHOD_BLOCKS

render_evidence_page("sofr_ted_spy", EVIDENCE_METHOD_BLOCKS)
