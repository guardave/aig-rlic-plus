"""Pair 6 — SOFR-TED × SPY Story (thin wrapper, Rule APP-PT1).
...
from pair_configs.sofr_ted_spy_config import STORY_CONFIG

render_story_page("sofr_ted_spy", STORY_CONFIG)
