"""Pair 6 — SOFR-TED × SPY Strategy (thin wrapper, Rule APP-PT1).
...
from pair_configs.sofr_ted_spy_config import STRATEGY_CONFIG

render_strategy_page("sofr_ted_spy", STRATEGY_CONFIG)
