...
**Priority combinations:** The live indicator-target pair universe lives in `data/prospective_pairs.csv` (generated by `scripts/build_prospective_pairs.py` from the user-curated `docs/Indicator x Target.csv`). 115 pairs as of 2026-06-02. Refer to it for "what pairs are in scope" — the portal's Status tab consumes it directly.
