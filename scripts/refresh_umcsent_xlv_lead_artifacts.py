#!/usr/bin/env python3
"""GH#13 native-derive of the coherent lead artifacts for indpro_xlp.
...
EVERY valid combo has oos_n == the full OOS window — INDPRO's contraction flag
never collapses over a 60m window in the OOS window, so no P2/P3-on-
...
# S-code -> parquet column (from pair_pipeline_indpro_xlp.py signal_cols)
SIGNAL_COL = {
    "S1_level": "umcsent", "S2_yoy": "umcsent_yoy", "S3_mom": "umcsent_mom",
    "S4_zscore": "umcsent_zscore", "S5_3m_ma": "umcsent_3m_ma",
    "S6_direction": "umcsent_direction", "S7_dev_ma": "umcsent_dev_ma",
}
...
def main() -> int:
    ...
    man.update({
        ...
        "clean_envelope_note": (
            "Native-derived (scripts/refresh_indpro_xlp_lead_artifacts.py) because the "
